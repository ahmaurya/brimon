...
implementation {
	...
	components SenseM as App;
	components MainC, LedsC;
	components new TimerMilliC() as TheftTimer;
	components new Msp430AxisXC() as Accel;
	//components new Msp430InternalVoltageC() as Accel;
	...
	*/
	...
	App.Boot -> MainC.Boot;
	App.Leds -> LedsC;
	App.TheftTimer -> TheftTimer;
	App.Accel -> Accel.ReadStream;
	/*
	App.Timer0 -> Timer0;
	App.Timer1 -> Timer1;

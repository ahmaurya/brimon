...
generic configuration AccelZStreamC() {
...
implementation {
  ...
  ReadStream = AccelReadStreamP.ReadStreamZ[ID];
  AccelReadStreamP.ActualZ[ID] -> AdcReadStreamClientC;
  AdcReadStreamClientC.AdcConfigure -> AccelConfigP.ConfigZ;
}
